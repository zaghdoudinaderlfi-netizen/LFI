...
// Pas d'import de photo pour les élèves (décision du prof : trop de risque
// de photos inappropriées) — seul le constructeur d'avatar dessiné
// (enregistrerAvatarAction ci-dessus) est disponible côté élève. La photo
// réelle reste réservée au prof, voir app/prof/profil/actions.ts.
