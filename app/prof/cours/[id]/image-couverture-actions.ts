...
import { CoursError, televerserImageCouverture } from "@/lib/cours";
import { supabaseAdmin, BUCKET_IMAGES_COURS } from "@/lib/supabase";

export async function modifierImageCouvertureAction(
